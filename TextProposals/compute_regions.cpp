...
#define CHANNEL_B    0 // Use Blue color channel
...
void ComputeRegions::operator()(Mat img, vector<HCluster> &regions_info)
{
    // Params
    ...
    Mat src, grey, lab_img, gradient_magnitude; //,img
