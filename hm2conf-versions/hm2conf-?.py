...
if __name__=='__main__':
	...
	#Define curve color for each curve (Raul)
	colors={}
	colors['Weak Classifier'] = 'r'
	colors['FCN ICDAR'] = '#339933'
	colors['FCN COCO'] = 'b'
	colors['FCN SYNTH'] = '#cc9900'
	colors['Suppression 0.05'] = '#ff9900'
	colors['Suppression 0.10'] = 'g'
	colors['Suppression 0.25'] = '#000066'


        for confStr in sortedKeysByLegends:
        #for confStr in confDict.keys():
            plt.plot(resGtObjDetected[confStr].astype('float')/(resGtObjCount/len(confDict.keys())), colors.get(confDict[confStr]) ,label=confDict[confStr])
